...
public class DataInitialization {
    ...
    public void contextRefreshedEvent() {
        ...
        ApplicationUser user1 = new ApplicationUser(null, "Jack", "Smith", "jack@gmail.com", simplePassword, ApplicationUserRole.USER);
        ApplicationUser user2 = new ApplicationUser(null, "Alvin", "Ellison", "alvin@gmail.com", simplePassword, ApplicationUserRole.USER);
        ApplicationUser user3 = new ApplicationUser(null, "Eadie", "Martins", "eadie@gmail.com", simplePassword, ApplicationUserRole.COMPANY_OWNER);
        ApplicationUser user4 = new ApplicationUser(null, "India", "Olsen", "india@gmail.com", simplePassword, ApplicationUserRole.COMPANY_OWNER);
        ApplicationUser user5 = new ApplicationUser(null, "Saskia", "Rees", "saskia@gmail.com", simplePassword, ApplicationUserRole.COMPANY_OWNER);
        ApplicationUser user6 = new ApplicationUser(null, "Emmett", "Lutz", "emmet@gmail.com", simplePassword, ApplicationUserRole.COMPANY_OWNER);
        ApplicationUser user7 = new ApplicationUser(null, "Maddie", "Gray", "maddie@gmail.com", simplePassword, ApplicationUserRole.COMPANY_OWNER);
        ApplicationUser user8 = new ApplicationUser(null, "Tara", "Pogancev", "admin@gmail.com", simplePassword, ApplicationUserRole.ADMIN);
